    ...
    return {
        ...
        async load(id) {
            if (id === RESOLVED_VIRTUAL_MODULE_ID) {
                // tentar carregar os dados do diretório de dados
                ...
                try {
                    ...
                    // caso o arquivo não exista, retornar array vazio
                    console.warn('dado de popularidade de node não encontrado em', dataPath, '- utilizando array vazio');
