...
declare module 'v3-infinite-loading' {
    ...
    const InfiniteLoading: DefineComponent<InfiniteLoadingProps, {}, {}, {}, {}, {}, {}, Events> & Plugin;
...
/**
 * declaração de módulo wa-sqlite accesshandlepoolvfs
 * 
 * esse vfs utiliza o access handle pool: origin private file
 * system (opfs)
 * 
...
declare module 'wa-sqlite/src/examples/AccessHandlePoolVFS.js' {
    export class AccessHandlePoolVFS implements SQLiteVFS {
        ...
        /** cria uma nova instância accesshandlepoolvfs */
        static create(name: string, module: unknown): Promise<AccessHandlePoolVFS>;

        /** clona o vfs e lança recursos */
        close(): Promise<void>;

        /** checa se o arquivo existe (check de acesso sincronizado) */
        jAccess(name: string, flags: number, pResOut: DataView): number;

        // métodos da interface sqlitevfs
