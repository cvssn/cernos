...
const esmDependencies = [
    ...
    // adicione outras dependências esm que precisam ser transformadas aqui
];
...
const config = {
    ...
    transformIgnorePatterns: [
        `/node_modules/(?!${esmDependenciesPattern})/`
    ],

    // isso resolve os mapeamentos de path do tsconfig relativo para cada jest.config.js
    moduleNameMapper: {
        '^@cernos/utils$': resolve(__dirname, 'packages/@cernos/dist/index.cjs'),
